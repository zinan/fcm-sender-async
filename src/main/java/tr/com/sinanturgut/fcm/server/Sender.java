...
import tr.com.sinanturgut.fcm.server.internal.FcmResponseEntity;
import tr.com.sinanturgut.fcm.server.internal.FcmResponseListEntity;
...
/**
 * The main interface to sending FCM messages.  Thread safe.
 *
...
public class Sender {
   ...
   *
   * @param apiKey Your application's FCM API key.
   */
  ...
  private static final class ResponseHandler implements FutureCallback<HttpResponse> {
    ...
    private Result parseResult(String body) throws IOException {
      List<FcmResponseEntity> responseList = objectMapper.readValue(body, FcmResponseListEntity.class)
                                                         .getResults();
      ...
      FcmResponseEntity responseEntity = responseList.get(0);
